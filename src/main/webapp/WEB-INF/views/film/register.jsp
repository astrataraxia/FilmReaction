	...
	<div class="wrapper_register">
		...
		<div class="register_body">
			<form class="register_form">
				<div class="register_title" method="post">
					<input class="title_area" maxlength="50" placeholder="제목" required></input>
				</div>
				<!--별점-->
				...
				<div class="register_written">
					<textarea class="written_area"placeholder="내용" required></textarea>
				</div>
				<!--제출 버튼-->
